...
public class Reader {
    ...
    public static String getPlqual() {
        if (vars.isWin) {
            try (BufferedReader reader = new BufferedReader(new FileReader(vars.plq))) {
                while ((vars.tmp = reader.readLine()) != null) {
                    vars.plqval = vars.tmp;
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(vars.lplq))) {
                while ((vars.tmp = reader.readLine()) != null) {
                    vars.plqval = vars.tmp;
    ...
    public static String getPlformat() {
        if (vars.isWin) {
            try (BufferedReader reader = new BufferedReader(new FileReader(vars.plf))) {
                while ((vars.tmp = reader.readLine()) != null) {
                    vars.plfval = vars.tmp;
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(vars.lplf))) {
                while ((vars.tmp = reader.readLine()) != null) {
                    vars.plfval = vars.tmp;
    ...
    public static String getPlfrom() {
        if (vars.isWin) {
            try (BufferedReader reader = new BufferedReader(new FileReader(vars.plr))) {
                while ((vars.tmp = reader.readLine()) != null) {
                    vars.plrval = vars.tmp;
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(vars.lplr))) {
                while ((vars.tmp = reader.readLine()) != null) {
                    vars.plrval = vars.tmp;
    ...
    public static int getCnval() {
        if (vars.isWin) {
            try (BufferedReader reader = new BufferedReader(new FileReader(vars.cn))) {
                while ((vars.tmp = reader.readLine()) != null) {
                    vars.cnval = Integer.parseInt(vars.tmp);
            ...
            try (BufferedReader reader = new BufferedReader(new FileReader(vars.lcn))) {
                while ((vars.tmp = reader.readLine()) != null) {
                    vars.cnval = Integer.parseInt(vars.tmp);
